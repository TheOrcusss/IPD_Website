  ...
  return (
    <main className="p-6 w-full space-y-4">
      ...
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
        {/* Left Side: Welcome & Patient Info */}
        <div>
          ...
          <ul className="mt-2 list-disc list-inside text-gray-700 text-sm">
            ...
            <li>3 patients coming for a follow-up</li>
          </ul>
        </div>

        {/* Right Side: New Diagnosis Button */}
      ...
      <section className="w-full">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold m-0 text-lg font-bold text-black">Recent Patients</h2>
          <Link
            to="/patients"
